...
const prefectureBlocks = [
  {
    ...
    prefectureId: 1,
    name: '北海道',
    rect: { width: 150, height: 110, x: 50, y: 10 },
    text: { x: 525, y: 65 },
  },
  {
    id: 'pref02',
    prefectureId: 2,
    name: '青森',
    rect: { width: 64, height: 40, x: 482, y: 30 },
    text: { x: 514, y: 50 },
  },
  {
    id: 'pref03',
    prefectureId: 3,
    name: '岩手',
    rect: { width: 64, height: 40, x: 514, y: 70 },
    text: { x: 546, y: 90 },
  },
  {
    id: 'pref04',
    prefectureId: 4,
    name: '宮城',
    rect: { width: 64, height: 40, x: 514, y: 110 },
    text: { x: 546, y: 130 },
  },
  {
    id: 'pref05',
    prefectureId: 5,
    name: '秋田',
    rect: { width: 64, height: 40, x: 450, y: 70 },
    text: { x: 483, y: 90 },
  },
  {
    id: 'pref06',
    prefectureId: 6,
    name: '山形',
    rect: { width: 64, height: 40, x: 450, y: 110 },
    text: { x: 483, y: 130 },
  },
  {
    id: 'pref07',
    prefectureId: 7,
    name: '福島',
    rect: { width: 64, height: 40, x: 514, y: 150 },
    text: { x: 546, y: 170 },
  },
  {
    id: 'pref08',
    prefectureId: 8,
    name: '茨城',
    rect: { width: 54, height: 54, x: 514, y: 244 },
    text: { x: 540, y: 270 },
  },
  {
    id: 'pref09',
    prefectureId: 9,
    name: '栃木',
    rect: { width: 54, height: 54, x: 514, y: 190 },
    text: { x: 540, y: 216 },
  },
  {
    id: 'pref10',
    prefectureId: 10,
    name: '群馬',
    rect: { width: 64, height: 40, x: 450, y: 190 },
    text: { x: 483, y: 210 },
  },
  {
    id: 'pref11',
    prefectureId: 11,
    name: '埼玉',
    rect: { width: 64, height: 40, x: 450, y: 230 },
    text: { x: 483, y: 250 },
  },
  {
    id: 'pref12',
    prefectureId: 12,
    name: '千葉',
    rect: { width: 54, height: 54, x: 514, y: 298 },
    text: { x: 540, y: 325 },
  },
  {
    id: 'pref13',
    prefectureId: 13,
    name: '東京',
    rect: { width: 64, height: 40, x: 450, y: 270 },
    text: { x: 483, y: 290 },
  },
  {
    id: 'pref14',
    prefectureId: 14,
    name: '神奈川',
    rect: { width: 64, height: 40, x: 450, y: 310 },
    text: { x: 483, y: 330 },
  },
  {
    id: 'pref15',
    prefectureId: 15,
    name: '新潟',
    rect: { width: 64, height: 40, x: 450, y: 150 },
    text: { x: 483, y: 170 },
  },
  {
    id: 'pref16',
    prefectureId: 16,
    name: '富山',
    rect: { width: 40, height: 40, x: 370, y: 190 },
    text: { x: 390, y: 210 },
  },
  {
    id: 'pref17',
    prefectureId: 17,
    name: '石川',
    rect: { width: 64, height: 40, x: 330, y: 150 },
    text: { x: 362, y: 170 },
  },
  {
    id: 'pref18',
    prefectureId: 18,
    name: '福井',
    rect: { width: 40, height: 40, x: 330, y: 190 },
    text: { x: 350, y: 210 },
  },
  {
    id: 'pref19',
    prefectureId: 19,
    name: '山梨',
    rect: { width: 40, height: 40, x: 410, y: 250 },
    text: { x: 430, y: 270 },
  },
  {
    id: 'pref20',
    prefectureId: 20,
    name: '長野',
    rect: { width: 40, height: 60, x: 410, y: 190 },
    text: { x: 430, y: 220, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref21',
    prefectureId: 21,
    name: '岐阜',
    rect: { width: 40, height: 60, x: 370, y: 230 },
    text: { x: 390, y: 260, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref22',
    prefectureId: 22,
    name: '静岡',
    rect: { width: 40, height: 40, x: 410, y: 290 },
    text: { x: 430, y: 310 },
  },
  {
    id: 'pref23',
    prefectureId: 23,
    name: '愛知',
    rect: { width: 40, height: 40, x: 370, y: 290 },
    text: { x: 390, y: 310 },
  },
  {
    id: 'pref24',
    prefectureId: 24,
    name: '三重',
    rect: { width: 40, height: 60, x: 330, y: 290 },
    text: { x: 350, y: 320, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref25',
    prefectureId: 25,
    name: '滋賀',
    rect: { width: 40, height: 60, x: 330, y: 230 },
    text: { x: 350, y: 260, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref26',
    prefectureId: 26,
    name: '京都',
    rect: { width: 40, height: 60, x: 290, y: 230 },
    text: { x: 310, y: 260, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref27',
    prefectureId: 27,
    name: '大阪',
    rect: { width: 40, height: 60, x: 250, y: 290 },
    text: { x: 270, y: 320, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref28',
    prefectureId: 28,
    name: '兵庫',
    rect: { width: 40, height: 60, x: 250, y: 230 },
    text: { x: 270, y: 260, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref29',
    prefectureId: 29,
    name: '奈良',
    rect: { width: 40, height: 60, x: 290, y: 290 },
    text: { x: 310, y: 320, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref30',
    prefectureId: 30,
    name: '和歌山',
    rect: { width: 64, height: 40, x: 250, y: 350 },
    text: { x: 282, y: 370 },
  },
  {
    id: 'pref31',
    prefectureId: 31,
    name: '鳥取',
    rect: { width: 40, height: 40, x: 210, y: 230 },
    text: { x: 230, y: 250 },
  },
  {
    id: 'pref32',
    prefectureId: 32,
    name: '島根',
    rect: { width: 40, height: 40, x: 170, y: 230 },
    text: { x: 190, y: 250 },
  },
  {
    id: 'pref33',
    prefectureId: 33,
    name: '岡山',
    rect: { width: 40, height: 40, x: 210, y: 270 },
    text: { x: 230, y: 290 },
  },
  {
    id: 'pref34',
    prefectureId: 34,
    name: '広島',
    rect: { width: 40, height: 40, x: 170, y: 270 },
    text: { x: 190, y: 290 },
  },
  {
    id: 'pref35',
    prefectureId: 35,
    name: '山口',
    rect: { width: 40, height: 60, x: 130, y: 240 },
    text: { x: 150, y: 270, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref36',
    prefectureId: 36,
  ...
  },
  {
    ...
    prefectureId: 37,
    name: '香川',
    rect: { width: 54, height: 40, x: 186, y: 320 },
    text: { x: 213, y: 340 },
  },
  {
    id: 'pref38',
    prefectureId: 38,
    name: '愛媛',
    rect: { width: 56, height: 40, x: 130, y: 320 },
    text: { x: 158, y: 340 },
  },
  {
    id: 'pref39',
  ...
  },
  {
    ...
    prefectureId: 40,
    name: '福岡',
    rect: { width: 40, height: 60, x: 84, y: 240 },
    text: { x: 104, y: 270, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref41',
    prefectureId: 41,
    name: '佐賀',
    rect: { width: 40, height: 60, x: 44, y: 240 },
    text: { x: 64, y: 270, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref42',
    prefectureId: 42,
    name: '長崎',
    rect: { width: 40, height: 60, x: 4, y: 240 },
    text: { x: 24, y: 270, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref43',
    prefectureId: 43,
    name: '熊本',
    rect: { width: 40, height: 60, x: 44, y: 300 },
    text: { x: 64, y: 330, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref44',
    prefectureId: 44,
    name: '大分',
    rect: { width: 40, height: 60, x: 84, y: 300 },
    text: { x: 104, y: 330, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref45',
    prefectureId: 45,
    name: '宮崎',
    rect: { width: 40, height: 60, x: 84, y: 360 },
    text: { x: 104, y: 390, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref46',
    prefectureId: 46,
    name: '鹿児島',
    rect: { width: 40, height: 60, x: 44, y: 360 },
    text: { x: 64, y: 390, writingMode: 'vertical-rl' },
  },
  {
    id: 'pref47',
    prefectureId: 47,
    name: '沖縄',
    rect: { width: 100, height: 80, x: 420, y: 420 },
    text: { x: 470, y: 460 },
  },
];
      ...
      <div className="japan-map-svg-container" ref={mapRef}>
        {loading ? (
          ...
          <svg viewBox="0 0 610 550" className="japan-map-svg">
            {/* Dividers */}
            <polyline points="0,135 240,135 440,0" stroke="#ccc" strokeWidth="2" fill="none" />
            <polyline points="610,410 380,410 280,550" stroke="#ccc" strokeWidth="2" fill="none" />
